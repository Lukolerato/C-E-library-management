...
namespace ElibraryManagement
{
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        protected void Button2_Click1(object sender, EventArgs e) //issue 
        {
        ...
        protected void Button4_Click1(object sender, EventArgs e) //return
        {
            if (checkIfBookExist() && checkIfMemberExist())
            {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e) //przetrzymanie książki, czerwony kolor 
        {
            try
            {
